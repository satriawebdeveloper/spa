              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label align="right" for="Id" class="col-sm-2 col-form-label">Id Admin :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="id">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="nama_obat" class="col-sm-2 col-form-label">Id Pengguna :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="nama_obat">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="jenis_obat" class="col-sm-2 col-form-label">Status:</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="jenis_obat">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="ukuran" class="col-sm-2 col-form-label">Jumlah :</label>
                    <div class="col-sm-6">
