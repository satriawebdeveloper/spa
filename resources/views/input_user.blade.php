            ...
            <div class="card-body"> 
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label align="right" for="jenis_obat" class="col-sm-2 col-form-label">Password :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="jenis_obat">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="ukuran" class="col-sm-2 col-form-label">Email :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="ukuran">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="stok" class="col-sm-2 col-form-label">Level :</label>
                    <div class="col-sm-6">
