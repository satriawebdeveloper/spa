              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label align="right" for="Id" class="col-sm-2 col-form-label">Id :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="id">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="nama_obat" class="col-sm-2 col-form-label">Nama Obat :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="nama_obat">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="jenis_obat" class="col-sm-2 col-form-label">Jenis Obat :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="jenis_obat">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="ukuran" class="col-sm-2 col-form-label">Ukuran :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="ukuran">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label align="right" for="stok" class="col-sm-2 col-form-label">Stok :</label>
                    <div class="col-sm-6">
